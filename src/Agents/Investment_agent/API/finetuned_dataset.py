# RUN THIS, FETCHES 10 YEARS DATA. SAVES FINAL DATASET WITH ALL THE TEHCNICAL INIDICATORS FOR ALL STOCKS. 
...
#RUN THIS AFTER THE FINETUNE DATASET FILE IS SAVED. IT SAVES THE TRAIN SET WITH BALANCED LABELS. SAVES TRAIN, VAL, TEST SPLITS FOR TRAINING.
